...
A simple Next.js app backed by Supabase for collecting family information and displaying it as a tree. Each member stores English name, Chinese name, phone, email and a picture.
